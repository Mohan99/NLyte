...
<%@ page import=" com.gcs.nlyte.web.persistance.dao.entity.NlyteUsers" %>
 ...
 <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
  ...
  <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
	  <div class="navbar-header"> <a class="navbar-brand" href="#"> <img src="img/logo.png" width="180"> </a> <h3 class="headding">Nlyte Material Lookup</h3> </div>
    ...
    <ul class="nav navbar-right navbar-top-links" >
      ...
      <li class="dropdown"> <a class="dropdown-toggle" data-toggle="dropdown" href="#"> <i class="fa fa-user fa-fw"></i> <%=user.getLoginId()%><b class="caret"></b> </a>
      ...
      <div class="sidebar-nav navbar-collapse" >
		  <div class="" style="margin-top: 16px; background-color: rgba(0,0,0,0.9); min-height: 100vh">
            ...
            <li> <a href="dashboard"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a> </li>
             <li> <a href="changePwd"><i class="fa fa-dashboard fa-fw"></i> Change Password</a> </li> 
           <%if(flag==true) {%>
            <li> <a href="#"><i class="fa fa-user-md fa-fw"></i> User Management<span class="fa arrow"></span></a>
              <ul class="nav nav-second-level">
                ...
                <li><a href="nlyteUserList"><i class="fa fa-search fa-fw"></i>Active User List</a>
                <li><a href="nlyteDeletedUserList"><i class="fa fa-search fa-fw"></i> Deleted User List</a>  
            ...
            <li> <a href="#" onClick="disableBack()"><i class="fa fa-user-md fa-fw"></i> Material Lookup<span class="fa arrow"></span></a>
              <ul class="nav nav-second-level">
              <%if(flag==true) {%>
                <li> <a href="nlyteCustomerImportListMain"> <i class="fa fa-list fa-fw"></i> Material Lookup List</a> </li>
                <%} %>
                <%if(flag==false) {%>
                <li> <a href="nlyteCustomerImportList"> <i class="fa fa-list fa-fw"></i> Material Lookup List</a> </li>
                <%} %>
                 <!-- <li> <a href="nlyteCustomerReviewImportList"> <i class="fa fa-list fa-fw"></i> Review Material Lookup List</a> </li>

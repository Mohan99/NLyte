...
<script type="text/javascript">
	...
	function myFunDelete(nlyteUserId) {
		var r = window.confirm("Do you want to delete the user?");
		if (r == true) {
			window.location.href = "nlyteDeleteUser?nlyteUserId=" + nlyteUserId;
		}
	}
</script>
<!-- Page Content -->
		...
		<div class="row">
			...
			<div class="panel panel-default" style="margin-top: 50px;">
					<div class="panel-heading">
						<h4>User Management - Active User List</h4>
					</div>
										...
										<thead>
											<tr role="row" class="bg-warning">
												...
												<th class="sorting" tabindex="0"
													...
													style="width: 207px;">User Display Name</th>
												<th class="sorting" tabindex="0"
													aria-controls="dataTables-example" rowspan="1" colspan="1"
													aria-label="Designation: activate to sort column ascending"
													style="width: 188px;">First Name</th>
												<th class="sorting" tabindex="0"
													aria-controls="dataTables-example" rowspan="1" colspan="1"
													aria-label="Project Name: activate to sort column ascending"
													style="width: 148px;">Last Name</th>
												<th class="sorting" tabindex="0"
													aria-controls="dataTables-example" rowspan="1" colspan="1"
													aria-label="Project Name: activate to sort column ascending"
													style="width: 148px;">Middle Name</th>
												<th class="sorting" tabindex="0"
													aria-controls="dataTables-example" rowspan="1" colspan="1"
													aria-label="Project Name: activate to sort column ascending"
											...
											<form name="myForm" method="post">
												...
												<s:iterator value="nlyteUsers">
													...
													<tr class="gradeA odd " role="row">
														...
														<td class="center"><s:property
																value="userFirstNameTx" /></td>
														<td class="center"><s:property value="userLastNameTx" />
														</td>
														<td class="center"><s:property
																value="userMiddleNameTx" /></td>
														<td class="center"><s:property value="emailId" /></td>
														<td class="center"><s:property value="mobileTx" /></td>
														<td class="disabled"><a href="#" class="btn btn-info"
															onClick="myFun('<s:property  value = "loginId"/>')">Edit</a></td>
														<td class="disabled"><a href="#" class="btn btn-info"
															onClick="myFunDelete('<s:property  value = "nlyteUserId"/>')">Delete</a></td>
